...
def main():
    ...
    output_dir = "10_sentences"
    os.makedirs(output_dir, exist_ok=True)
    output_csv = ("surprisal.csv")  
    ...
    with open(output_csv, "w", newline="", encoding="utf-8") as csvfile:
        ...
        for sentence in test_sentences:
            ...
            if valid:
                # Calculate avarage surprisal of the sentence.
                avg_surprisal = get_test_surprisal(sentence, bigram_surprisal)
                # Add valid sentence into the list.
                valid_sentence.append(sentence)

                # Save the sentence into a .txt file.
                output_path = os.path.join(output_dir, f"sentence{len(valid_sentence)}.txt")
